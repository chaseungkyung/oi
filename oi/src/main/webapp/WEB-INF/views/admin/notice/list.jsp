		...
		<div class="wrapper">
			<div class="body-container">
				...
				<div class="body-main">
					<form name="listForm" method="post">
						<div class="row board-list-header">
							<div class="col-auto me-auto">
								<button type="button" class="btn btn-light" id="btnDeleteList"
									title="삭제">
							...
							<div class="col-auto">
								<c:if test="${dataCount != 0}">
									<select name="size" class="form-select"
										...
										<option value="10" ${size==10 ? "selected ":""}>10개씩
											출력</option>
										<option value="15" ${size==15 ? "selected ":""}>15개씩
											출력</option>
										<option value="20" ${size==20 ? "selected ":""}>20개씩
											출력</option>
										<option value="30" ${size==30 ? "selected ":""}>30개씩
											출력</option>
									</select>
								</c:if>

								<input type="hidden" name="page" value="${page}"> <input
									type="hidden" name="schType" value="${schType}"> <input
									type="hidden" name="kwd" value="${kwd}">
					...
					<div class="page-navigation">${dataCount != 0 ? paging : "등록된 게시글 없음"}
					</div>
					...
					<div class="row board-list-footer">
						...
						<div class="col text-end">
							<button type="button" class="btn btn-light"
								onclick="location.href='${pageContext.request.contextPath}/admin/notice/write?size=${size}';">글올리기</button>
						</div>
					</div>

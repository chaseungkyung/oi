...
<body>
	...
	<main>
		...
		<div class="meal">
			...
			<button type="button" onclick="addMeal()">등록</button>
		</div>
		...
		<div class="meal-record" id="mealRecord">
			<div class="meal">
				...
				<button class="btn mealinsertbtn" onclick="addMealEntry('breakfast')">+</button>
			</div>
			...
			<div class="meal">
				...
				<button class="btn mealinsertbtn" onclick="addMealEntry('lunch')">+</button>
			</div>
			...
			<div class="meal">
				...
				<button class="btn mealinsertbtn" onclick="addMealEntry('dinner')">+</button>
			</div>
